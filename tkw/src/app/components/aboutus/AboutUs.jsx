...
const testimonials = [
  {
    quote:
      "I appreciate the emphasis on safety in this martial arts course. are careful to ensure that students are trained in a safe environment and that they have the proper protective gear. As a coach, I feel confident that my students are in good hands.",
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="bg-black_3 relative">
        ...
        />
        <div className="max-w-[1200px] mx-auto px-8 md:pr-14 py-40 md:pt-40 pt-10 pb-96  md:pb-40">
          {/* About Us Section */}
          <div className="md:flex md:gap-20 md:mb-40 mb-20 relative">
          ...
          <div className="mt-12 flex flex-col-reverse md:flex-row">
            {/* Text Section */}
            <div className="flex-1 :mt-0 md:pr-4">
                ...
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    ...
                    <div className="mt-4">
                      ...
                      <div className="text-secondary_text text-base md:text-xl pb-20">
                        {testimonial.title}
                      </div>
                    </div>
                  </motion.div>
